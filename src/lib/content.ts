...
export const smoothflowTestimonials = [
  {
    ...
    location: "ঢাকা",
    rating: 5,
    text: "বুকের এক পাশে শক্ত চাকার মতো হয়ে তীব্র ব্যথা করছিল, বাবুকে দুধ খাওয়াতেই ভয় পেতাম। SmoothFlow নেওয়ার ২৪ ঘণ্টার মধ্যেই চাকা একদম সফট হয়ে যায় এবং ব্যথা নাই হয়ে গেছে!",
    avatar: "/assets/reviewer/girl1.jpeg",
  ...
  },
  {
    ...
    location: "চট্টগ্রাম",
    rating: 5,
    text: "ক্লগড ডাক্টের কারণে ফিডিং করানোর সময় চোখ দিয়ে পানি চলে আসতো। SmoothFlow ব্যবহারে ২ দিনের মধ্যে নালীর ব্লক পুরোপুরি ক্লিন হয়ে দুধের প্রবাহ একদম স্মুথ হয়েছে।",
    avatar: "/assets/reviewer/girl2.jpeg",
    verifiedPurchase: true,
    babyAge: "২ মাস",
  ...
  },
  {
    ...
    rating: 5,
    text: "আগে ফিডিং করানোর আগে মানসিকভাবে ভয় পেতাম। SmoothFlow সেবনের ৩ দিনের মধ্যে কোনো ব্যথা ছাড়াই বাবু সুন্দরভাবে দুধ খাচ্ছে।",
    avatar: "/assets/reviewer/girl4.jpeg",
    verifiedPurchase: true,
    babyAge: "১ মাস",
  ...
  },
  {
    ...
    location: "কুমিল্লা",
    rating: 5,
    text: "ডাক্তারের পরামর্শে SmoothFlow ট্রাই করি। ২ দিনের মধ্যে চাকা ভাব কেটে গেছে এবং বুকে জমাট বাঁধা দুধ স্বাচ্ছন্দ্যে রিলিজ হয়েছে।",
    avatar: "/assets/reviewer/girl1.jpeg",
    verifiedPurchase: true,
    babyAge: "৪ মাস",
