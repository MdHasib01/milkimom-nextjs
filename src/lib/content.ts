...
export const flavors = [
  {
    ...
    description: "চিয়া, ওটস ও\nচকলেটের সমৃদ্ধ স্বাদ",
    popular: true,
  ...
  },
  {
    ...
    tag: "মৃদু ও সুবাসিত",
    description: "চিয়া, দুধ ও ভ্যানিলার সমৃদ্ধ ফ্লেভার",
    popular: false,
    image: "/images/product-jar.webp",
  ...
  },
  {
    ...
    icon: "leaf" as const,
    tag: "ঐতিহ্যবাহী",
    description: "এলাচের ঘ্রাণ এই অনন্য স্বাদের সাথী",
    popular: false,
    image: "/images/product-jar.webp",
  ...
  },
  {
    ...
    icon: "flame" as const,
    tag: "উষ্ণ স্বাদ",
    description: "দারুচিনির উষ্ণতা, স্বাদ ও গন্ধে আরও স্পেশাল",
    popular: false,
    image: "/images/product-jar.webp",
