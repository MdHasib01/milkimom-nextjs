...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "মিল্কিমম ১০০% প্রাকৃতিক উপাদানে তৈরি এবং BSTI সার্টিফাইড। সাধারণত কোনো পার্শ্বপ্রতিক্রিয়া দেখা যায় না, তবে ব্যক্তিভেদে শারীরিক অবস্থা ভিন্ন হতে পারে বিধায় ব্যবহারের আগে ডাক্তারের পরামর্শ নেওয়া উত্তম।",
  },
  {
