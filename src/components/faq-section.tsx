...
const SMOOTHFLOW_FAQS: FaqItem[] = [
  {
    q: "স্মুথফ্লো কীভাবে ক্লগড ডাক্ট (Clogged Duct) ও বুকের শক্ত চাকা দূর করে?",
    a: "স্মুথফ্লো-এর প্রাকৃতিক অ্যান্টি-ইনফ্লেমেটরি ও ফ্লো-এনহ্যান্সিং উপাদান দুগ্ধনালীর জমাট বাঁধা ব্লক তরল ও উন্মুক্ত করে দেয়। ফলে ব্রেস্টের শক্ত চাকা অনুভূতি ও ফিডিং-এর সময়কার অসহ্য যন্ত্রণা দ্রুত দূর হয়।",
  },
  {
  ...
  {
    q: "স্মুথফ্লো খাওয়ার সঠিক নিয়ম কী?",
  ...
  {
    q: "আমার থাইরয়েড, ডায়াবেটিস বা প্রেশার থাকলে কি স্মুথফ্লো খেতে পারবো?",
