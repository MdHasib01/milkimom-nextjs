...
const SMOOTHFLOW_FAQS: FaqItem[] = [
  {
    q: "SmoothFlow কীভাবে ক্লগড ডাক্ট (Clogged Duct) ও বুকের শক্ত চাকা দূর করে?",
    a: "SmoothFlow-এর প্রাকৃতিক অ্যান্টি-ইনফ্লেমেটরি ও ফ্লো-এনহ্যান্সিং উপাদান দুগ্ধনালীর জমাট বাঁধা ব্লক তরল ও উন্মুক্ত করে দেয়। ফলে ব্রেস্টের শক্ত চাকা অনুভূতি ও ফিডিং-এর সময়কার অসহ্য যন্ত্রণা দ্রুত দূর হয়।",
  },
  {
    q: "কত দ্রুত (কত ঘণ্টার মধ্যে) ব্রেস্টের ব্যথা উপশম হবে?",
    a: "মাত্র ২৪ ঘণ্টার মধ্যেই বুকের শক্ত চাকা ভাব নরম হয়ে আসে এবং ফিডিং-এর সময় ব্যথা লক্ষণীয়ভাবে কমে যায়।",
  },
  {
    q: "বাচ্চার দুধ পানের সময় এটি কি শতভাগ নিরাপদ?",
    a: "হ্যাঁ, এটি ১০০% প্রাকৃতিক উপাদানে তৈরি, ক্ষতিকর কেমিক্যাল ও অ্যান্টিবায়োটিক মুক্ত এবং রেজিস্টার্ড চিকিৎসকদের অনুমোদিত, যা মা ও শিশু উভয়ের জন্যই সম্পূর্ণ নিরাপদ।",
  },
  {
    q: "SmoothFlow খাওয়ার সঠিক নিয়ম কী?",
    a: "দিনে ২ বার ১ গ্লাস কুসুম গরম পানি বা দুধের সাথে ১ চামচ মিশিয়ে খাবেন। প্যাকেটের সাথে পূর্ণাঙ্গ ডিরেকশন ম্যানুয়াল দেওয়া থাকে।",
  },
  {
    q: "ডোজ শেষ হলে কি ব্যথা বা ক্লগড ডাক্ট আবার ফিরে আসতে পারে?",
    a: "না, এটি ল্যাকটিফেরাস ডাক্টের প্রবাহ স্থায়ীভাবে স্বাভাবিক রাখতে সাহায্য করে, তাই বারবার আক্রান্ত হওয়ার ঝুঁকি কমায়।",
  },
  {
    q: "আমার থাইরয়েড, ডায়াবেটিস বা প্রেশার থাকলে কি SmoothFlow খেতে পারবো?",
    a: "জ্বী, এটি সম্পূর্ণ ন্যাচারাল ও ল্যাব টেস্টেড হওয়ায় শারীরিক অন্যান্য সমস্যা থাকলেও নিশ্চিন্তে খাওয়া যায়।",
  },
];
...
export function FaqSection() {
  ...
  const rawFaqs = content.productSlug === "smoothflow" ? SMOOTHFLOW_FAQS : FAQS;

  const formattedFaqs = rawFaqs.map((faq) => ({
