...
const FAQS: FaqItem[] = [
  ...
  { q: "মিল্কিমম জিনিসটা কী?", a: "মিল্কিমম বুকের দুধ তৈরি, বৃদ্ধি ও বুকের দুধে পুষ্টি উপাদান বজায় রাখার জন্য একটি সেমি লিকুইড সাপ্লিমент।" },
  ...
  { 
    ...
    a: (
      <div className="space-y-3">
        ...
        <p>মিল্কিমম সম্পূর্ণ ন্যাচারাল, ল্যাব টেস্টেড, সাইডইফেক্ট মুক্ত এবং মায়েদের জন্য তৈরি একটি সেমি-লিকুইড সাপ্লিমент।</p>
      </div>
    )
  },
