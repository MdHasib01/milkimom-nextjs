...
const doctorsList = [
  ...
  },
  {
    ...
    quote:
      "“SmoothFlow-এর সুষম ফর্মুলা মায়ের বুকের শক্ত চাকার অনুভূতি ও চাপ দূর করে দুধের স্বাভাবিক প্রবাহ নিশ্চিত করে। এটি শতভাগ নিরাপদ এবং পার্শ্বপ্রতিক্রিয়ামুক্ত।”",
