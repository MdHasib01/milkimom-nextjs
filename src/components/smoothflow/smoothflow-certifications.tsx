...
const doctorsList = [
  ...
  {
    id: 5,
    name: "ডাঃ তানজিলা রহমান",
    qualifications: "এমবিবিএস, এফসিপিএস (গাইনি এন্ড অব্স)",
    title: "বিশেষজ্ঞ গাইনি চিকিৎসক",
    quote:
      "“বুকের দুধ খাওয়ানোর সময় ব্রেস্ট পেন ও শক্ত চাকা ভাব থাকলে স্মুথফ্লো দ্রুত স্বস্তি দেয়। মা ও সন্তানের স্বাস্থ্য ও পুষ্টি সুরক্ষায় এটি অত্যন্ত কার্যকর।”",
    img: "/assets/carousel/doctor.webp",
  },
];
    ...
    <section className="py-12 md:py-20 relative bg-brand-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <a
            href="#order-section"
            className="w-full sm:w-auto bg-brand text-white font-black text-lg md:text-xl px-8 py-4 md:px-10 rounded-full shadow-[0_6px_25px_rgba(230,16,110,0.35)] hover:shadow-[0_8px_30px_rgba(230,16,110,0.45)] text-center transition-all hover:-translate-y-0.5 active:translate-y-0"
          >
