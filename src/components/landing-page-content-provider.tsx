...
const DEFAULT_SECTION_CONTENTS: Record<string, LandingPageSectionContent> = {
  ...
  smoothflow: {
    ...
    doctorQuote: "ক্লগড ডাক্ট ও ফিডিং-এর সময় ব্যথা মায়েদের দৈনন্দিন শারীরিক ও মানসিক কষ্টে ফেলে দেয়। স্মুথফ্লোর ফর্মুলেশন ল্যাকটিফেরাস ডাক্টের ব্লক মুক্ত করে মাত্র ২৪ ঘন্টায় স্বস্তি এনে দেয়।",
    doctorImage: "/assets/doctor/doctor.png",
    orderHeadline: "আজই স্মুথফ্লো™ অর্ডার করুন",
    orderSubheadline: "একটি painful Feeding-এর দাম টাকা দিয়ে মাপা যায় না। বিশেষ লঞ্চ ছাড়ে অর্ডার সম্পন্ন করুন।",
    guaranteeTitle: "১০০% কোয়ালিটি ও স্বস্তি নিশ্চিতকরণ গ্যারান্টি",
    guaranteeText: "আমাদের পণ্য সম্পূর্ণ ল্যাব টেস্টেড ও সার্টিফাইড। আমরা দিচ্ছি শতভাগ গুণগত মান ও স্বস্তির নিশ্চয়তা।",
  ...
  stableflow: {
    ...
    logoType: "text",
    logoImage: "/images/logo.webp",
    announcementText: "⚡ স্মুthFlow বিশেষ অফার! ৪২% ছাড় - লঞ্চ প্রাইস মাত্র ৳১,৯৯৯ (রেগুলার ৳৩,৪৫০, সাশ্রয় ৳১,৪৫১)!",
    heroBadge: "১০০% সাইডইফেক্ট মুক্ত ও সেফ ফর্মুলা",
    heroTitle: "বাচ্চাকে দুধ খাওয়াতে গেলেই বুকের ব্যথা? মাত্র ২৪ ঘন্টায় মুক্তি পান।",
    heroTitleHighlight: "মাত্র ২৪ ঘন্টায় মুক্তি পান।",
    heroSubtitle: "বুকের এক পাশে শক্ত চাকার মতো অনুভূতি, চাপ, Tenderness, আর Feed করানোর সময় অস্বস্তি—এগুলো সবই Clogged-Duct Related।",
