...
const FAQS = [
  ...
  },
  {
    ...
    a: "MilkReady-তে রয়েছে শতভাগ ৩ দিনের মানি ব্যাক গ্যারান্টি পলিসি। ব্যবহার করে কোনো পরিবর্তন অনুভব না করলে সম্পূর্ণ টাকা রিফান্ড পেয়ে যাবেন (এটা রিফান্ড পলিসি অনুযায়ী)।",
  },
];
