      ...
      <div className="mx-auto flex w-full max-w-4xl items-center justify-between gap-3 min-w-0">
        ...
        <div className="flex items-center shrink-0">
          <button
            ...
            className="cta-shine h-10 sm:h-11 gap-2 rounded-full bg-[#FFD100] px-4 sm:px-6 text-xs sm:text-base font-extrabold text-slate-900 hover:bg-[#FACC15] shadow-md whitespace-nowrap shrink-0 flex items-center justify-center transition-all cursor-pointer active:scale-95"
          >
