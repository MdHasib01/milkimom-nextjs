...
const doctorsList = [
  ...
  },
  {
    id: 2,
    name: "ডা. মোঃ নাজমুল",
    qualifications: "এমবিবিএস, ডিজিইউ",
    quote:
      "“MilkReady-তে থাকা প্রাকৃতিক উপাদান ও পুষ্টি উপাদানগুলো গর্ভাবস্থার শেষ ৩ মাসে মায়ের শরীরের ল্যাকটোজেনিক হরমোনের প্রাকৃতিক প্রস্তুতিতে অত্যন্ত কার্যকরী সহায়তা প্রদান করে।”",
    img: "/assets/doctors/nazmul.webp",
  },
  {
    id: 3,
    name: "ডা. হাদিসুর রহমান",
    qualifications: "এমবিবিএস",
    quote:
      "“নবজাতকের জন্য প্রথম ৬ মাস মায়ের বুকের দুধের কোনো বিকল্প নেই। প্রসবের পর থেকেই পর্যাপ্ত বুকের দুধ নিশ্চিত করতে MilkReady একটি নিরাপদ ও নির্ভরযোগ্য প্রস্তুতি।”",
  ...
  },
  {
    ...
    qualifications: "এমবিবিএস, এফসিপিএস",
    quote:
      "“ডেলিভারির আগে থেকেই ব্রেস্ট ডাক্ট সক্রিয় ও ল্যাকটেশন প্রস্তুতি সম্পন্ন করতে MilkReady একটি চিকিৎসাবিজ্ঞান সমর্থিত ও সম্পূর্ণ নির্ভরযোগ্য প্রাকৃতিক সমাধান।”",
